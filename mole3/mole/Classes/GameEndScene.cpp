...
bool GameEndScene::init(){
    ...
    //タイトルを設置
    auto lbl_title = LabelTTF::create("ゲームオーバー", "HiraKakuProN-W6", 30);
    ...
    auto startButton = MenuItemImage::create(
                                             ...
                                             CC_CALLBACK_1(GameEndScene::pushStart, this)); // 押下時のアクション
...
void GameEndScene::pushStart(Object *pSender)
{
